		...
		<main class="_content-area">
			<div class="dashboard-area">
				...
				<div class="dashboard-stats">
					<a href="./myReport.php?status=Pending">
					...
					<a href="./myReport.php?status=Assigned">
						<div class="dashboard-box">
							<div class="dashboard-header">
					...
					<a href="./myReport.php?status=In_Progress">
						<div class="dashboard-box">
							<div class="dashboard-header">
					...
					<a href="./myReport.php?status=Completed">
						<div class="dashboard-box">
							<div class="dashboard-header">
					...
					<a href="./myReport.php?status=Rejected">
						<div class="dashboard-box">
							<div class="dashboard-header">
					...
					<a href="./myReport.php?status=Cancelled">
						<div class="dashboard-box">
							<div class="dashboard-header">
